...
class AudiovisualControllerTest extends WebTestCase
{
    private KernelBrowser $client;
    private AudiovisualRepository $repository;
    private string $path = '/audiovisual/';
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Audiovisual index');
    ...
    public function testShow(): void
    {
        ...
        self::assertResponseStatusCodeSame(200);
        self::assertPageTitleContains('Audiovisual');
